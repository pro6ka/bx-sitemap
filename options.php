<?php
    ...
    defined('ADMIN_MODULE_NAME') or define('ADMIN_MODULE_NAME', 'pro6ka.sitemap');
    ...
    if ((!empty($save) || !empty($restore)) && $request->isPost() && check_bitrix_sessid()) {
        if (!empty($restore)) {
            ...
            (new CAdminMessage)->showMessage(Loc::getMessage("REFERENCES_INVALID_VALUE"));
        }
    }
